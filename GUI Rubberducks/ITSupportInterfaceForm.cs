...
{
	public partial class ITSupportInterfaceForm : Form
	{
		...
		public ITSupportInterfaceForm(Employee emp)
		{
			InitializeComponent();
			employee = emp;
		...
		private void ITSupportInterface_Load(object sender, EventArgs e)
		{
			tickets = objDBHandler.LoadDataFromDb();
		...
		private void ITSupportInterface_FormClosed(object sender, FormClosedEventArgs e)
		{
			EmployeeLoginForm login = new EmployeeLoginForm();
			login.Show();
		}
