...
{
	public partial class ProjectMemberInterfaceForm : Form
	{
		...
		public ProjectMemberInterfaceForm(Employee emp)
		{
			InitializeComponent();
			employee = emp;
		...
		private void ProjectMemberInterface_Load(object sender, EventArgs e)
		{
		...
		private void btnOpenTickets_Click_1(object sender, EventArgs e)
		{
			tickets = objDBHandler.LoadDataFromDb();
		...
		private void ProjectMemberInterface_FormClosed(object sender, FormClosedEventArgs e)
		{
			EmployeeLoginForm login = new EmployeeLoginForm();
			login.Show();
		}
		...
		private void btnViewTicket_Click(object sender, EventArgs e)
		{
			...
			if (lsbTickets.SelectedItem == null)
			{
				MessageBox.Show("You did not select a ticket!", "Error!");
			}
		}
